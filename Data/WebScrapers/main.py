...
statsDF = pd.read_csv(r'C:\Projects\NFLPredictor\Data\Test-Data\CombinedStats\CombinedStats2020.csv')
...
games = [['Buffalo Bills', 'Indianapolis Colts'],['Los Angeles Rams', 'Seattle Seahawks'],
         ['Tampa Bay Buccaneers', 'Washington Football Team'],['Baltimore Ravens' ,'Tennessee Titans'],
         ['New Orleans Saints','Chicago Bears'],['Cleveland Browns','Pittsburgh Steelers']]
...
for i in range(len(games)):
    ...
    b = games[i][1]
    location = ['','@','@','@','','@']
    teamInfo.append([a, statsDF.loc[statsDF['Name']==a], 1, 0])
...
location = r'C:\Projects\NFLPredictor\Model\AidansModels\RandomForest'
name = '\MatchUp2020WildCard.csv'
path = location + name
